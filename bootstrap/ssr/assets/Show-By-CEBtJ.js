...
import { _ as _sfc_main$6, a as _sfc_main$b } from "./ConditionLike-B8gmHh2g.js";
import { a as _sfc_main$c, _ as _sfc_main$d } from "./PrimaryLink-BhP3udGA.js";
import { _ as _sfc_main$a } from "./Heading1-B5GMPk_G.js";
import { _ as _sfc_main$7 } from "./Heading3-q7V9h2MZ.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.seller.id !== unref(user).id) {
        ...
        _push(ssrRenderComponent(_sfc_main$c, {
          ...
          href: _ctx.route("chat.show", { offer: __props.offer.id })
        }, null, _parent));
