...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Vojta\bakalarka\gearly\public\storage' => 'string',
            ...
            'world.allowed_countries' => 'array',
            'world.disallowed_countries' => 'array',
            'world.accepted_locales' => 'string',
            'world.modules.states' => 'boolean',
            'world.modules.cities' => 'boolean',
            'world.modules.timezones' => 'boolean',
            'world.modules.currencies' => 'boolean',
            'world.modules.languages' => 'boolean',
            'world.routes' => 'boolean',
            'world.connection' => 'string',
            'world.migrations.countries.table_name' => 'string',
            'world.migrations.countries.optional_fields.phone_code.required' => 'boolean',
            'world.migrations.countries.optional_fields.phone_code.type' => 'string',
            'world.migrations.countries.optional_fields.phone_code.length' => 'integer',
            'world.migrations.countries.optional_fields.iso3.required' => 'boolean',
            'world.migrations.countries.optional_fields.iso3.type' => 'string',
            'world.migrations.countries.optional_fields.iso3.length' => 'integer',
            'world.migrations.countries.optional_fields.native.required' => 'boolean',
            'world.migrations.countries.optional_fields.native.type' => 'string',
            'world.migrations.countries.optional_fields.region.required' => 'boolean',
            'world.migrations.countries.optional_fields.region.type' => 'string',
            'world.migrations.countries.optional_fields.subregion.required' => 'boolean',
            'world.migrations.countries.optional_fields.subregion.type' => 'string',
            'world.migrations.countries.optional_fields.latitude.required' => 'boolean',
            'world.migrations.countries.optional_fields.latitude.type' => 'string',
            'world.migrations.countries.optional_fields.longitude.required' => 'boolean',
            'world.migrations.countries.optional_fields.longitude.type' => 'string',
            'world.migrations.countries.optional_fields.emoji.required' => 'boolean',
            'world.migrations.countries.optional_fields.emoji.type' => 'string',
            'world.migrations.countries.optional_fields.emojiU.required' => 'boolean',
            'world.migrations.countries.optional_fields.emojiU.type' => 'string',
            'world.migrations.states.table_name' => 'string',
            'world.migrations.states.optional_fields.country_code.required' => 'boolean',
            'world.migrations.states.optional_fields.country_code.type' => 'string',
            'world.migrations.states.optional_fields.country_code.length' => 'integer',
            'world.migrations.states.optional_fields.state_code.required' => 'boolean',
            'world.migrations.states.optional_fields.state_code.type' => 'string',
            'world.migrations.states.optional_fields.state_code.length' => 'integer',
            'world.migrations.states.optional_fields.type.required' => 'boolean',
            'world.migrations.states.optional_fields.type.type' => 'string',
            'world.migrations.states.optional_fields.latitude.required' => 'boolean',
            'world.migrations.states.optional_fields.latitude.type' => 'string',
            'world.migrations.states.optional_fields.longitude.required' => 'boolean',
            'world.migrations.states.optional_fields.longitude.type' => 'string',
            'world.migrations.cities.table_name' => 'string',
            'world.migrations.cities.optional_fields.country_code.required' => 'boolean',
            'world.migrations.cities.optional_fields.country_code.type' => 'string',
            'world.migrations.cities.optional_fields.country_code.length' => 'integer',
            'world.migrations.cities.optional_fields.state_code.required' => 'boolean',
            'world.migrations.cities.optional_fields.state_code.type' => 'string',
            'world.migrations.cities.optional_fields.state_code.length' => 'integer',
            'world.migrations.cities.optional_fields.latitude.required' => 'boolean',
            'world.migrations.cities.optional_fields.latitude.type' => 'string',
            'world.migrations.cities.optional_fields.longitude.required' => 'boolean',
            'world.migrations.cities.optional_fields.longitude.type' => 'string',
            'world.migrations.timezones.table_name' => 'string',
            'world.migrations.currencies.table_name' => 'string',
            'world.migrations.languages.table_name' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.media.driver','filesystems.disks.media.root',
'filesystems.disks.media.url','filesystems.disks.media.visibility','filesystems.links.C:\\Users\\Vojta\\bakalarka\\gearly\\public\\storage','logging.default','logging.deprecations.channel',
...
'media-library.force_lazy_loading','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'reverb.apps.apps.0.activity_timeout','reverb.apps.apps.0.max_message_size','services.postmark.token','services.ses.key','services.ses.secret',
...
'world.allowed_countries','world.disallowed_countries','world.accepted_locales','world.modules.states','world.modules.cities',
'world.modules.timezones','world.modules.currencies','world.modules.languages','world.routes','world.connection',
'world.migrations.countries.table_name','world.migrations.countries.optional_fields.phone_code.required','world.migrations.countries.optional_fields.phone_code.type','world.migrations.countries.optional_fields.phone_code.length','world.migrations.countries.optional_fields.iso3.required',
'world.migrations.countries.optional_fields.iso3.type','world.migrations.countries.optional_fields.iso3.length','world.migrations.countries.optional_fields.native.required','world.migrations.countries.optional_fields.native.type','world.migrations.countries.optional_fields.region.required',
'world.migrations.countries.optional_fields.region.type','world.migrations.countries.optional_fields.subregion.required','world.migrations.countries.optional_fields.subregion.type','world.migrations.countries.optional_fields.latitude.required','world.migrations.countries.optional_fields.latitude.type',
'world.migrations.countries.optional_fields.longitude.required','world.migrations.countries.optional_fields.longitude.type','world.migrations.countries.optional_fields.emoji.required','world.migrations.countries.optional_fields.emoji.type','world.migrations.countries.optional_fields.emojiU.required',
'world.migrations.countries.optional_fields.emojiU.type','world.migrations.states.table_name','world.migrations.states.optional_fields.country_code.required','world.migrations.states.optional_fields.country_code.type','world.migrations.states.optional_fields.country_code.length',
'world.migrations.states.optional_fields.state_code.required','world.migrations.states.optional_fields.state_code.type','world.migrations.states.optional_fields.state_code.length','world.migrations.states.optional_fields.type.required','world.migrations.states.optional_fields.type.type',
'world.migrations.states.optional_fields.latitude.required','world.migrations.states.optional_fields.latitude.type','world.migrations.states.optional_fields.longitude.required','world.migrations.states.optional_fields.longitude.type','world.migrations.cities.table_name',
'world.migrations.cities.optional_fields.country_code.required','world.migrations.cities.optional_fields.country_code.type','world.migrations.cities.optional_fields.country_code.length','world.migrations.cities.optional_fields.state_code.required','world.migrations.cities.optional_fields.state_code.type',
'world.migrations.cities.optional_fields.state_code.length','world.migrations.cities.optional_fields.latitude.required','world.migrations.cities.optional_fields.latitude.type','world.migrations.cities.optional_fields.longitude.required','world.migrations.cities.optional_fields.longitude.type',
'world.migrations.timezones.table_name','world.migrations.currencies.table_name','world.migrations.languages.table_name','concurrency.default','cors.paths',
...
'debugbar.queries.explain','sanctum.csrf-cookie','landingPage','chat.load',
'chat.send','wishlist.index','chat.show','chat.index',
'search.index','offer.create','offer.store','offer.edit','offer.update',
'offer.destroy','offer.index','offer.show','profile.edit','profile.update',
'profile.destroy','user.show','register','login','password.request','password.email','password.reset','password.store',
...
'country.0','response.0','world::country.AF','world::country.AX','world::country.AL',
'world::country.DZ','world::country.AS','world::country.AD','world::country.AO','world::country.AI',
'world::country.AQ','world::country.AG','world::country.AR','world::country.AM','world::country.AW',
'world::country.AU','world::country.AT','world::country.AZ','world::country.BS','world::country.BH',
'world::country.BD','world::country.BB','world::country.BY','world::country.BE','world::country.BZ',
'world::country.BJ','world::country.BM','world::country.BT','world::country.BO','world::country.BA',
'world::country.BW','world::country.BV','world::country.BR','world::country.IO','world::country.VG',
'world::country.BN','world::country.BG','world::country.BF','world::country.BI','world::country.KH',
'world::country.CM','world::country.CA','world::country.CV','world::country.BQ','world::country.KY',
'world::country.CF','world::country.TD','world::country.CL','world::country.CN','world::country.CX',
'world::country.CC','world::country.CO','world::country.KM','world::country.CG','world::country.CD',
'world::country.CK','world::country.CR','world::country.CI','world::country.HR','world::country.CU',
'world::country.CW','world::country.CY','world::country.CZ','world::country.DK','world::country.DJ',
'world::country.DM','world::country.DO','world::country.EC','world::country.EG','world::country.SV',
'world::country.GQ','world::country.ER','world::country.EE','world::country.SZ','world::country.ET',
'world::country.FK','world::country.FO','world::country.FJ','world::country.FI','world::country.FR',
'world::country.GF','world::country.PF','world::country.TF','world::country.GA','world::country.GM',
'world::country.GE','world::country.DE','world::country.GH','world::country.GI','world::country.GR',
'world::country.GL','world::country.GD','world::country.GP','world::country.GU','world::country.GT',
'world::country.GG','world::country.GN','world::country.GW','world::country.GY','world::country.HT',
'world::country.HM','world::country.HN','world::country.HK','world::country.HU','world::country.IS',
'world::country.IN','world::country.ID','world::country.IR','world::country.IQ','world::country.IE',
'world::country.IM','world::country.IL','world::country.IT','world::country.JM','world::country.JP',
'world::country.JE','world::country.JO','world::country.KZ','world::country.KE','world::country.KI',
'world::country.KW','world::country.KG','world::country.LA','world::country.LV','world::country.LB',
'world::country.LS','world::country.LR','world::country.LY','world::country.LI','world::country.LT',
'world::country.LU','world::country.MO','world::country.MG','world::country.MW','world::country.MY',
'world::country.MV','world::country.ML','world::country.MT','world::country.MH','world::country.MQ',
'world::country.MR','world::country.MU','world::country.YT','world::country.MX','world::country.FM',
'world::country.MD','world::country.MC','world::country.MN','world::country.ME','world::country.MS',
'world::country.MA','world::country.MZ','world::country.MM','world::country.NA','world::country.NR',
'world::country.NP','world::country.NL','world::country.NC','world::country.NZ','world::country.NI',
'world::country.NE','world::country.NG','world::country.NU','world::country.NF','world::country.KP',
'world::country.MK','world::country.MP','world::country.NO','world::country.OM','world::country.PK',
'world::country.PW','world::country.PS','world::country.PA','world::country.PG','world::country.PY',
'world::country.PE','world::country.PH','world::country.PN','world::country.PL','world::country.PT',
'world::country.PR','world::country.QA','world::country.RE','world::country.RO','world::country.RU',
'world::country.RW','world::country.WS','world::country.SM','world::country.ST','world::country.SA',
'world::country.SN','world::country.RS','world::country.SC','world::country.SL','world::country.SG',
'world::country.SX','world::country.SK','world::country.SI','world::country.SB','world::country.SO',
'world::country.ZA','world::country.GS','world::country.KR','world::country.SS','world::country.ES',
'world::country.LK','world::country.BL','world::country.SH','world::country.KN','world::country.LC',
'world::country.MF','world::country.PM','world::country.VC','world::country.SD','world::country.SR',
'world::country.SJ','world::country.SE','world::country.CH','world::country.SY','world::country.TW',
'world::country.TJ','world::country.TZ','world::country.TH','world::country.TL','world::country.TG',
'world::country.TK','world::country.TO','world::country.TT','world::country.TN','world::country.TR',
'world::country.TM','world::country.TC','world::country.TV','world::country.UM','world::country.VI',
'world::country.UG','world::country.UA','world::country.AE','world::country.GB','world::country.US',
'world::country.UY','world::country.UZ','world::country.VU','world::country.VA','world::country.VE',
'world::country.VN','world::country.WF','world::country.EH','world::country.YE','world::country.ZM',
'world::country.ZW','world::country.XK','world::response.errors.server_error','world::response.errors.record_not_found','world::response.attributes.phone',
'world::response.attributes.country','world::response.attributes.city','world::response.attributes.state','world::response.attributes.timezone','world::response.attributes.currency',
'world::response.attributes.language',);
