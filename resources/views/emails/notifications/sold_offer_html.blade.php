...
<head>
    <meta charset="UTF-8">
    <title>Byla ti prodána nabídka!</title>
</head>
    ...
    <div
        ...
        <div style="padding:24px; color: #000;">
            <p style="font-size:16px;margin-bottom:20px;">
                Ahoj,<br><br>
                uživatel <strong>{{ $senderName }}</strong> ti právě prodal nabídku
                <strong>{{ $offerName }}</strong>. Poté co nabídku vyzvedneš, můžeš tohoto uživatele ohodnotit.
                Ohledně předání a platby se domluv s uživatelem <strong>{{ $senderName }}</strong> v chatu.
            </p>
