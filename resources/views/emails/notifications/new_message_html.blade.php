...
<head>
    <meta charset="UTF-8">
    <title>Nová zpráva na Gearly!</title>
</head>
    ...
    <div
        ...
        <div style="padding:24px; color: #000;">
            <p style="font-size:16px;margin-bottom:20px;">
                Ahoj,<br><br>
                přišla ti nová zpráva od uživatele <strong>{{ $senderName }}</strong> ohledně nabídky
                <strong>{{ $offerName }}</strong>.
            </p>

            <div
                style="background-color:#f9f9f9;border-left:4px solid #1D9E1D;padding:16px;margin:24px 0; color: #000;">
        ...
        <div style="background-color:#000000;padding:12px;text-align:center;">
            <p style="color:#ffffff;font-size:12px;margin:0;">© {{ date('Y') }} Gearly.eu – Baseball & Softball Bazar
            </p>
        </div>
